...
console.log(massJohn,massMark,heightJohn,heightMark)

let bmiMark=massMark/heightMark**2
let bmiJohn=massJohn/(heightJohn*heightJohn)
let higherBmiMark=bmiMark>bmiJohn
console.log(bmiMark,bmiJohn,higherBmiMark)
...
*/
// solution
//if(bmiMark>bmiJohn){console.log('Marks bmi is higher than John')}
//else{console.log('Marks bmi is less than John')};
// console.log(`Marks bmi ${bmiMark} is less than Johns bmi ${bmiJohn}`);
...
// bonus1
    ...
    //   else{console.log('nobody win the trophy');}
...
(If it's easier for you, you can start with an if/else statement, and then try to convert it to a
 ternary operator!)
...
// console.log(`bill is of ${bill} and tip is ${tip} then total amount ${totalbill}`)
...
/*
Back to the two gymnastics teams, the Dolphins and the Koalas! There is a new gymnastics discipline, which 
works differently.
...
// let avgDolphins=calcAverage(125,125,95)
...
calculated based on the rules above (you can check out the code from first tip calculator challenge if you
 need to). Use the function type you like the most. Test the function using a bill value of 100.
...
calculations! Remember: BMI = mass / height ** 2 = mass / (height * height). (mass in kg and height in meter)
...
calculates the average of all numbers in the given array. This is a DIFFICULT challenge (we haven't done 
this before)! Here is how to solve it:
  ...
  variable 'sum' that starts at 0. Then loop over the array using a for loop. In each iteration, 
  add the current value to the 'sum' variable. This way, by the end of the loop, you have all values 
  added together
...
const calcTip= function (bill) {
   ...
   const bills=[22,25,176,440,37,105,10,1100,86 ,52]
   const tips=[]
   const totalBills=[]
